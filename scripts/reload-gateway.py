...
def main():
    ...
    ok, stdout, stderr = run_cmd(["sudo", "openclaw", "gateway", "stop"])
    if not ok:
    ...
    if model_id:
        ...
        ok, stdout, stderr = run_cmd(["sudo", "openclaw", "config", "set", 
    ...
    ok, stdout, stderr = run_cmd(["sudo", "openclaw", "gateway", "start"])
    if not ok:
